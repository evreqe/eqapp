...
private:
    ...
    std::array<std::string, 256> m_clientGlobalChannelList;
    std::array<std::string, 256> m_clientChannelList;
...
bool BoxChatServer::Load()
{
    ...
    for (size_t i = 0 ; i < m_numClients; i++)
    {
        ...
        m_clientGlobalChannelList[i] = "Global1";
        m_clientChannelList[i] = "Default";
    }
        ...
        if (FD_ISSET(m_recvSocket, &m_ReadFdSet))
        {
            ...
            if (errorCode == WSAECONNRESET)
            {
                ...
                (
                    ...
                    m_clientNameList[i],
                    m_clientGlobalChannelList[i],
                    m_clientChannelList[i]
                );
            ...
            else
            {
                ...
                for (auto& recvTextToken : recvTextList)
                {
                    ...
                    {
                        std::print("#{} [{}] ({}): {}\n", m_clientNameList[i], m_clientGlobalChannelList[i], m_clientChannelList[i], recvTextToken);
                    }
                    ...
                    if (wordList.size() > 1)
                    {
                        ...
                        if (wordList.at(0) == "$ClientGlobalChannel")
                        {
                            ...
                            if (clientGlobalChannelName.size() != 0)
                            {
                                for (size_t k = 0; k < m_numClients; k++)
                                {
                                    if (m_clientSocketList[k] == m_recvSocket)
                                    {
                                        m_clientGlobalChannelList[k] = clientGlobalChannelName;

                                        std::print("Client socket index '{}' assigned to client global channel '{}'\n", m_clientSocketList[k], clientGlobalChannelName);
                        ...
                        if (wordList.at(0) == "$ClientChannel")
                        {
                            ...
                            if (clientChannelName.size() != 0)
                            {
                                for (size_t k = 0; k < m_numClients; k++)
                                {
                                    if (m_clientSocketList[k] == m_recvSocket)
                                    {
                                        m_clientChannelList[k] = clientChannelName;

                                        std::print("Client socket index '{}' assigned to client channel '{}'\n", m_clientSocketList[k], clientChannelName);
                        ...
                        if (wordList.at(0) == "//BCT" || wordList.at(0) == "//BoxChatTell")
                        {
                            bBCT  = true;
                            bBCTC = false;
                            bBCA  = false;
                        ...
                        if (wordList.at(0) == "//BCTC" || wordList.at(0) == "//BoxChatToChannel")
                        {
                            bBCT  = false;
                            bBCTC = true;
                            bBCA  = false;
                        ...
                        if (wordList.at(0) == "//BCA" || wordList.at(0) == "//BoxChatOthers")
                        {
                            bBCT  = false;
                            bBCTC = false;
                            bBCA  = true;
                        ...
                        if (wordList.at(0) == "//BCAA" || wordList.at(0) == "//BoxChatAll")
                        {
                            bBCT  = false;
                            bBCTC = false;
                            bBCA  = false;
                        ...
                        if (bBroadcast == true)
                        {
                            ...
                            {
                                if (m_clientGlobalChannelList[sendIndex] != m_clientGlobalChannelList[recvIndex])
                                {
                                    continue;
                                }
                            }
                            ...
                            for (size_t j = 0; j < m_numClients; j++)
                            {
                                ...
                                else if (bBCTC == true)
                                {
                                    ...
                                    if (m_clientChannelList[j] != sendToChannelName)
                                    {
                                        continue;
                                    }
